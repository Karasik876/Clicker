...
BOOST_TYPE_CHOICES = {
    ...
    (BOOST_TYPE_NAME_TO_NUMBER['brs'], 'brs'),
}
...
BOOST_TYPE_VALUES = {
    ...
    BOOST_TYPE_NAME_TO_NUMBER['auto']: {
        ...
        'auto_click_power_scale': 4, # В автоматическом бусте сила автоклика останется прежней.
        'price_scale': 15, # Невероятно вырастет в цене.
    },
    BOOST_TYPE_NAME_TO_NUMBER['brs']: {
        'click_power_scale': 0,
